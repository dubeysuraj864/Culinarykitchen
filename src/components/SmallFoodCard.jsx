...
function SmallFoodCard(props) {
  return (
    <>
      <div className="small-food-card w-[44vw] h-[32vh] md:w-[22vw] md:h-[39vh] m-1 md:m-2 relative flex justify-center items-end text-white rounded-[20px] cursor-pointer">
        <img
          src={props.image}
          className="absolute top-0 w-[44vw] h-[32vh] md:w-[22vw] md:h-[39vh] object-cover rounded-[20px]"
          alt="food"
        />
        <div className="content group bg-[#fff] hover:bg-[#000] text-black hover:text-white transition-all  opacity-[0.8] lg:p-2 px-2 lg:px-4 rounded-b-[20px]">
          ...
          <div className="buttons py-2 flex justify-between text-xs">
            <button className=" py-1 lg:py-2 rounded-[15px] flex items-center">
              ...
              <img
                src={Right}
                className="w-[18px] mx-2 invert group-hover:invert-0 "
                alt="Right"
              />
            </button>
